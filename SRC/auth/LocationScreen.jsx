  ...
  return (
    <div className="kt-scroll">
      ...
      <div className="screen-pad">
        ...
        {selectedCity && (
          <>
            <div className="field-label" style={{ marginTop: 18, marginBottom: 8 }}>Complete address</div>
            <input
        ...
        <button
          ...
          disabled={!selectedCity || !completeAddress.trim() || gpsState === "requesting"}
          style={(!selectedCity || !completeAddress.trim() || gpsState === "requesting") ? { opacity: 0.4 } : {}}
          onClick={finish}
        >
