      ...
      <div style={styles.contentScroll}>
        ...
        <div style={styles.heroCard}>
          ...
          <div style={styles.kpBadge}>
            <Sparkles size={14} color="#1E3A8A" style={{ marginRight: 6 }} />
            <span>{estimatedKp.toLocaleString()} KP Pending Award</span>
          </div>
        ...
        <div style={styles.ctaFooterGroup}>
          ...
          <div style={styles.optionalNote}>
            ...
            <span>Community Verification is required — your Karma Points are awarded only after 5 members verify this listing.</span>
          </div>
        </div>
      </div>
    </div>
