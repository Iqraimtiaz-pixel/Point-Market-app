...
export function HomeScreen({ userLocation, currentUser, onOpenDetail, onTrade, onOpenMap, onOpenProfile, onOpenPmSpace, onOpenCreate, onOpenProducts, onOpenSkills }) {
  ...
  return (
    <div className="home-locked-light">
      ...
      {/* ── New: Products / Skills primary entry points ── */}
      <div className="home-action-grid">
        <div className="home-action-card products" onClick={() => onOpenProducts?.()}>
          <div className="home-action-icon"><ShoppingBag size={20} /></div>
          <div className="home-action-title">Products</div>
          <div className="home-action-sub">Buy, sell and discover amazing products around you.</div>
          <div className="home-action-cta">Explore Products <ChevronRight size={13} /></div>
        </div>
        <div className="home-action-card skills" onClick={() => onOpenSkills?.()}>
          <div className="home-action-icon"><Handshake size={20} /></div>
          <div className="home-action-title">Skills</div>
          <div className="home-action-sub">Offer your skills or find the perfect service.</div>
          <div className="home-action-cta">Explore Skills <ChevronRight size={13} /></div>
        </div>
      </div>
