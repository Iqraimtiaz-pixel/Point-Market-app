...
const CSS = `
  ...
  .feed-video {
    height: 232px; position: relative; display: flex; align-items: center; justify-content: center; overflow: hidden;
  }
  ...
  .category-badge { position: absolute; top: 10px; left: 10px; background: rgba(255,255,255,0.9); backdrop-filter: blur(6px); color: var(--sea-dark); padding: 3px 10px; border-radius: 999px; font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; z-index: 2; }
  .feed-emoji { font-size: 64px; position: relative; z-index: 1; filter: drop-shadow(0 8px 18px rgba(15,28,23,0.15)); }
  .duration-badge { position: absolute; bottom: 10px; left: 10px; background: rgba(11,18,32,0.5); color: #fff; padding: 4px 10px; border-radius: 999px; font-size: 10.5px; font-weight: 600; z-index: 2; backdrop-filter: blur(6px); }
  ...
  /* ── SIDEBAR ACTIONS ── */
  .feed-actions { position: absolute; right: 10px; bottom: 10px; display: flex; flex-direction: column; align-items: center; gap: 7px; z-index: 3; }
  .act-wrap { display: flex; flex-direction: column; align-items: center; gap: 2px; }
  .act-btn { width: 34px; height: 34px; border-radius: 999px; background: rgba(255,255,255,0.94); border: none; display: flex; align-items: center; justify-content: center; box-shadow: 0 3px 10px rgba(15,28,40,0.14); cursor: pointer; backdrop-filter: blur(6px); transition: transform .15s cubic-bezier(.34,1.56,.64,1); }
