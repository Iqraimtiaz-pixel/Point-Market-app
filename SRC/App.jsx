      ...
      {deleteTarget && (
        <div className="sheet-backdrop" onClick={(e) => { if (e.target === e.currentTarget && !deleting) setDeleteTarget(null); }}>
          <div className="sheet">
            ...
            <p className="sheet-sub">"{deleteTarget.title}" will be permanently removed. This can't be undone.</p>
...
const CSS = `
  ...
  .profile-avatar { width: 78px; height: 78px; border-radius: 999px; background: var(--sea-light); display: flex; align-items: center; justify-content: center; font-size: 36px; margin-bottom: 10px; overflow: hidden; }
  ...
  .profile-grid-tile { position: relative; aspect-ratio: 1 / 1; overflow: hidden; background: var(--sea-light); cursor: pointer; }
  ...
  .listings-grid-tile { display: flex; flex-direction: column; cursor: pointer; }
  .listings-grid-thumb { position: relative; aspect-ratio: 1 / 1; border-radius: 12px; overflow: hidden; display: flex; align-items: center; justify-content: center; }
